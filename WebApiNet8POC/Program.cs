...
using WebApiNet8POC.MappingProfiles;
using WebApiNet8POC.Middleware;
using WebApiNet8POC.Repositories.Implementations;
using WebApiNet8POC.Repositories.Interfaces;
using WebApiNet8POC.Services.Implementations;
using WebApiNet8POC.Services.Interfaces;
using WebApiNet8POC.Services.Validators;

namespace WebApiNet8POC
{
